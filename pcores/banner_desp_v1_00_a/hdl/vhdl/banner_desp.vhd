------------------------------------------------------------------------------
-- banner_desp.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          banner_desp.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Mon Nov 26 17:29:57 2018 (by Create and Import Peripheral Wizard)
...
library banner_desp_v1_00_a;
use banner_desp_v1_00_a.user_logic;
...
end entity banner_desp;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of banner_desp is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity banner_desp_v1_00_a.user_logic
    generic map
    (
